...
public class Main {
    ...
    private static com.jobs.persistence.EmployeeRepository employeesList = new EmployeeRepository();
    private static JobsController controller=new JobsController(employeesList);
